...
// ===================================================================
// NINE DOT MENU CONFIGURATION - Easy access to change menu URLs
// ===================================================================
// IMPORTANT: Edit these URLs to change where the nine-dot menu items link to
// SVG icons are embedded in the template (search for "nineDotMenu" to find them)
// ===================================================================

const MENU_LINKS = {
  GENIE_HOME: 'https://go/genieplus',
  GENIE: 'https://go/genie',
  SOFIA: 'https://go/sofia',
  RADAR: 'https://radarscreen.novartis.net/',
  COST_INSIGHT: 'https://testnovartis.eu10.sapanalytics.cloud/sap/fpa/ui/app.html#/analyticapp&/aa/9E48A6079A04B51F119A9098225AE966/?mode=present',
  DOST: 'https://share.novartis.net/sites/BPABI',
  DIG_FIN: 'https://go/digfin',
  IDEAS: 'https://novartis.imaginatik.com/novartisidc9.nsf/idcintroVisual?openform'
};
