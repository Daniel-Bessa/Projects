(function()  {
  ...
  customElements.define('com-sap-side-navigation-menu-test', class SideNavigationMenuTest extends HTMLElement {
    ...
    connectedCallback(){
      ...
      /*
            ...
            "children": [{
							"name": "Proxy Sales",
							"uid": "2CB86107C80A55E359F9D229D4FE4F8C"
							},
							{
								"name": "Forecast Accuracy",
								"uid": "C888107C80F893D5BCBFB9A7D665542"
							},
							{
								"name": "PVM",
								"uid": "22180E04DC8D1E73331D078436435475"
							}
            ]
          },
          {
            ...
            "children": [{
                ...
                "uid": "61309201F013FA429549454EF50F3B06"
              },
              {
                "name": "Launches",
                "uid": "13B80E820C93141256512A40A4C03163"
              },
              {
                "name": "Baseline",
                "uid": "DEE82D0447236AFF96CEC02E2CA67253"
              },
              {
                "name": "Competitors",
                "uid": "6BA87A01F01381CD8BBACF2D8E99BDD6"
              },
              {
                "name": "Generics",
                "uid": "89809201F013A17E9A0A70468F5FCD75"
              },
              {
                "name": "AI Scope",
                "uid": "5696F07AACC081BDC89EF07A4040F0E"
              },
              {
                "name": "Sales Outliers",
                "uid": "90702D80F8E9136C5AE597B454F48CE2"
              },
            ]
          },
          {
            ...
            "children": [{
              ...
              "uid": "317816820C92BD2FD1E046A87F393039"
              },
              {
                "name": "Cash Outliers",
                "uid": "7FC0FD822A6429EA4A0922852D2CB93F"
              }
            ]
          },
          {
            ...
            "roles": "",
            "children": [{
              "name": "Price Assumptions",
              "uid": "3B582A82D6B79ADF020C593651ADD9AF"
              },
              {
                "name": "Brand Events",
                "uid": "F4286D822A63B89DD8807713F6A192A0"
              },
              {
                "name": "Workday Calendar",
                "uid": "ECF02E06DA31176301716B83B39E0563"
              }
            ]},
          {
            "text": "Admin",
            ...
            "children": [{
              ...
              "uid": "44885E06DA30BA403C1A62486262E984"
              },
              {
                "name": "Cluster",
                "uid": "26104E878CEE1863F52A3AAB1F82FDD5"
              },
              {
                "name": "Flatfile Uploads",
                "uid": "820056878CEAA9B770B7BDA7310D9253"
              },
              {
                "name": "Run over Run Analytics",
                "uid": "66005804C15A3DBD5137A05F1AD177A9"
              },
              {
                "name": "AI Flex Launch pad",
                "uid": "E5E804069B094A7D0A00F91DFAFB725C"
              }
            ]
          },
        ];
				//setSelectedFirstMenuItem(that, data);
        createElements(that, data);
			}
      */
    }
  ...
  function loadthis(that){
    ...
    // Only toggle if explicitly set to true or false, not empty string or undefined
    ...
    // If _toggleSideParameter is empty/undefined, don't change the state
    ...
    // proxySalesID = "78D0008242D0C55256839C3C457B854B";
    // aiPerformanceID = "549876079A03223EB3509FA8F67EFE3B";
    ...
    if(that._shadowRoot.getElementById("container-admin")){
      let containerAdmin = that._shadowRoot.getElementById("container-admin");
      let adminUl = that._shadowRoot.getElementById("MenuAdminUL");
      // containerAdmin.add();
      for(let i=0; i < _AccessParameter_value.length; i++){
        ...
        if (typeof _AccessParameter_value === 'undefined' || _AccessParameter_value === null || !_AccessParameter_value){
          ...
          if (AccessParameterArray !== "TM_CLD_SAC_DEV" && AccessParameterArray !== "TM_CLD_SAC_SUPP_NCON" && AccessParameterArray !== "TM_CLD_SAC_SUPP_CONF" && AccessParameterArray !== "TM_AIDA_PWR_W"){
            ...
            // Ensure admin submenu is hidden when access is granted
            if(adminUl) adminUl.style.display = "none";
            // proxySalesID = "FC5030841BFB6B4DFB4C85F6C7F43068";
            // aiPerformanceID = "BB9010841BFB53F0E8F6EAEFE0CA932E";
          }
        }
      }
    }
    ...
    // Ensure the menu stays in collapsed state unless explicitly toggled
    // This handles the case where setAccess is called and we need to maintain collapsed state
    if (_toggleSideParameter !== true) {
      // Explicitly ensure all submenus are hidden and menu is collapsed
      ...
      if (fourthUl) fourthUl.style.display = "none";
      if (firstUl) firstUl.style.display = "none";
      if (secondUl) secondUl.style.display = "none";
      if (thirdUl) thirdUl.style.display = "none";
      if (adminUl) adminUl.style.display = "none";
  ...
  function interactiveMenu(that){
    ...
    // Set parent container widths to collapsed state
    ...
    // Initialize all container items to collapsed width
  ...
  function setSelectedFirstMenuItem(that){
    ...
    */
    ...
    if (UrlIDString == menu4_href7){
      menu4.classList.add("setSelectedParent");
      icon4.classList.add("path");
      menu4_link7.classList.add("setSelectedItem");
      menu4_link7.addEventListener('click', function (event) {
        event.preventDefault();
      });
      span_arrow[2].style.stroke="#fff";
    }else {
      menu4_link7.classList.remove("setSelectedItem");
    }

    if (UrlIDString !== menu4_href2 && UrlIDString !== menu4_href3 && UrlIDString !== menu4_href4 /* && UrlIDString !== menu4_href5 */ && UrlIDString !== menu4_href6 && UrlIDString !== menu4_href7){
    ...
    if (that._shadowRoot.getElementById("container-admin")){
      ...
      if (UrlIDString == menuAdmin_href2){
        menuAdmin.classList.add("setSelectedParent");
        iconAdmin.classList.add("path");
        menuAdmin_link2.classList.add("setSelectedItem");
        menuAdmin_link2.addEventListener('click', function (event) {
          event.preventDefault();
        });
        span_arrow[2].style.stroke="#fff";
      }else {
        menuAdmin_link2.classList.remove("setSelectedItem");
      }

      if (UrlIDString == menuAdmin_href3){
        menuAdmin.classList.add("setSelectedParent");
        iconAdmin.classList.add("path");
        menuAdmin_link3.classList.add("setSelectedItem");
        menuAdmin_link3.addEventListener('click', function (event) {
          event.preventDefault();
        });
        span_arrow[2].style.stroke="#fff";
      }else {
        menuAdmin_link3.classList.remove("setSelectedItem");
      }

      // if (UrlIDString == menuAdmin_href4){
      //   menuAdmin.classList.add("setSelectedParent");
      //   iconAdmin.classList.add("path");
      //   menuAdmin_link4.classList.add("setSelectedItem");
      //   menuAdmin_link4.addEventListener('click', function (event) {
      //     event.preventDefault();
      //   });
      //   span_arrow[2].style.stroke="#fff";
      // }else {
      //   menuAdmin_link4.classList.remove("setSelectedItem");
      // }

      // if (UrlIDString == menuAdmin_href5){
      //   menuAdmin.classList.add("setSelectedParent");
      //   iconAdmin.classList.add("path");
      //   menuAdmin_link5.classList.add("setSelectedItem");
      //   menuAdmin_link5.addEventListener('click', function (event) {
      //     event.preventDefault();
      //   });
      //   span_arrow[2].style.stroke="#fff";
      // }else {
      //   menuAdmin_link5.classList.remove("setSelectedItem");
      // }
  
      if (UrlIDString !== menuAdmin_href1 && UrlIDString !== menuAdmin_href2 && UrlIDString !== menuAdmin_href3 /* && UrlIDString !== menuAdmin_href4 */ && UrlIDString !== menuAdmin_href5 && UrlIDString !== menuAdmin_href6){
  ...
  //#endregion
  /*
  function createElements(that, menuItems){
		console.log("setSelectedFirstMenuItem menuItemsJSONs", menuItems);
    let navMenuBar = that._shadowRoot.getElementById("nav");

    for(let i=0; i < menuItems.length; i++){
      
      let containerItem = document.createElement("div");
      if(menuItems[i].roles === "admin"){
        containerItem.setAttribute("class", "container-item container-admin");
        containerItem.setAttribute("id", "container-admin");
      }else {
        containerItem.setAttribute("class", "container-item");
      }
      let containerMenu = document.createElement("div");
      containerMenu.setAttribute("class", "container-menu");
      if(menuItems[i].roles === "admin"){
        containerMenu.setAttribute("id", "MenuAdmin");
      }else {
        containerMenu.setAttribute("id", "Menu" + [i]);
      }
        let spanItem = document.createElement("span");
        if(menuItems[i].roles === "admin"){
          spanItem.setAttribute("id", "iconAdmin");
        }else {
          spanItem.setAttribute("id", "icon" + [i]);
        }
        spanItem.innerHTML = menuItems[i].svg;
          let buttonItem = document.createElement("button");
          if(menuItems[i].roles === "admin"){
            buttonItem.setAttribute("id", "MenuAdmin.Button");
          }else {
            buttonItem.setAttribute("id", "Menu" + [i] + ".Button");
          }
          buttonItem.setAttribute("class", "menu");
          buttonItem.innerHTML = menuItems[i].text;
        let smallItem = document.createElement("small");
        smallItem.setAttribute("class", "arrow rotate-small");
          let svgArrow = document.createElementNS("http://www.w3.org/2000/svg", "svg");
          let svgPathArrow = document.createElementNS("http://www.w3.org/2000/svg", "path");
          svgArrow.setAttribute("viewBox", "0 0 16 10");
          svgArrow.setAttribute("width", "16px");
          svgArrow.setAttribute("height", "10px");
          svgArrow.setAttribute("fill", "none"); 
          svgPathArrow.setAttribute("class", "span-arrow");
            svgPathArrow.setAttribute("d", "M15 8.5L8 1.5L1 8.5");
            svgPathArrow.setAttribute("stroke", "#fff");
            svgPathArrow.setAttribute("stroke-width", "2");
      let containerUl = document.createElement("ul");
      if(menuItems[i].roles === "admin"){
        containerUl.setAttribute("id", "MenuAdminUL");
      }else {
        containerUl.setAttribute("id", "Menu" + [i] + "UL");
      }

      navMenuBar.appendChild(containerItem);
      containerItem.appendChild(containerMenu);
      containerItem.appendChild(containerUl);
      containerMenu.appendChild(spanItem);
      containerMenu.appendChild(buttonItem);
      containerMenu.appendChild(smallItem);
        smallItem.appendChild(svgArrow);
        svgArrow.appendChild(svgPathArrow);

      let menuItemChildren = menuItems[i].children;

      for(let u=0; u < menuItemChildren.length; u++){
        let menuListItem = document.createElement("li");
        if(menuItems[i].roles === "admin"){
          menuListItem.setAttribute("id", "MenuAdmin.Opt" + [u]);
        }else {
          menuListItem.setAttribute("id", "Menu" + [i] + ".Opt" + [u]);
        }
          let listItemAnchor = document.createElement("a");
        containerUl.appendChild(menuListItem);
          menuListItem.appendChild(listItemAnchor);
          listItemAnchor.innerHTML = menuItemChildren[u].name;
          if(menuItems[i].roles === "admin"){
            listItemAnchor.setAttribute("id", "MenuAdmin.link" + [u]);
          }else {
            listItemAnchor.setAttribute("id", "Menu" + [i] + ".link" + [u]);
          }
          listItemAnchor.setAttribute("target", menuItemChildren[u].name);
      }
    }
  }
	*/
