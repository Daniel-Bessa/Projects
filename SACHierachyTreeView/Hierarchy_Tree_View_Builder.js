(function () {
		...
		<form id="form">
			<fieldset>
				...
				<table>
					...
					<tr>
						<td >Logic Type</td>
						<td><select class="form-control" name="Logic Type" id="Logic_Mode" >
                        <option selected="selected" value="ParentChild">Parent-Child</option>
  ...
  class MultiInput extends HTMLElement {
    ...
    set Logic_Mode(newLogic_Mode) {
      this._shadowRoot.getElementById("Logic_Mode").value = newLogic_Mode;
    }
    get Logic_Mode() {
      return this._shadowRoot.getElementById("Logic_Mode").value;
    }
  ...
  customElements.define("com-ds-hierarchy-tree-view-sap-sac-alive-builder", MultiInput);
})();
